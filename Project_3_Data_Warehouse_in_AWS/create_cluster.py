...
#function to create role for the iam user
...
#function to attach the newly created role to the iam user
...
#function to create the redshift cluster for the project
...
#function to describe cluster to see status
